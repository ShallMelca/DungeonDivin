    ...
    private static void Initialize()
    {
        if (Instance == null)
        {
            ...
            if (prefab == null)
            {
                ...
                Debug.LogError("[GenerateSoundManager] SoundManager not found in Resources folder.");
                return;
            }
            ...
            ADXSoundManager.Instance.SetCueReference(soundManager.GetComponent<CueSheetsManager>());
        }
    }
